        ...
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl">
            <form action="{{ route('posts.store') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="titulo" name="titulo" placeholder="Titulo de la publicación" class="border p-4 w-full rounded-lg @error('titulo') border-red-500  @enderror" value="{{ old('titulo') }}">
                ...
                <div class="mb-5">
                    ...
                    <textarea id="descripcion" name="descripcion" placeholder="Descripcion.." class="border p-4 w-full rounded-lg @error('descripcion') border-red-500  @enderror">{{ old('descripcion') }}</textarea>
